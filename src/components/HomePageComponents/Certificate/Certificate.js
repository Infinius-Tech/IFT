...
//   const images = [
//     { id: 1, alt: "Fasai Certificate", caption: "Fasai Certificate" , src: "/images/certificates/fasai_certificate.jpg"},
//     { id: 2, alt: "Halal Certificate", caption: "Halal Certificate", src: "/images/certificates/halal_certificate.jpg" },
//     { id: 3, alt: "Import Certificate", caption: "Import Certificate", src: "/images/certificates/import_certificate.jpg" },
//     { id: 4, alt: "ISO Certificate", caption: "ISO Certificate", src: "/images/certificates/iso_certificate.jpg" }
//   ];

//   return (
//     <section className="py-16 bg-white">
//       <div className="container mx-auto px-4">
//         <h2 className="text-3xl md:text-4xl font-bold text-center text-[#8B4513] mb-12">Food Certificate</h2>
        
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
//           {images.map(image => (
//             <div key={image.id} className="relative group overflow-hidden rounded-lg">

//               <div className="h-[500px] shadow-emerald-700 border-amber-900 shadow-2xl p-4 flex items-center justify-center">
//                 <Image 
//                   src={image.src} 
//                   alt={image.alt} 
//                   fill
...
//                 height={400}     // keep aspect ratio close to your images
//                 className="border-4 border-amber-900 rounded-lg shadow-2xl object-contain"
//               />
//             </div>
//           ))}
//         </div>
