...
// import { indianFoodTechEmail, indianFoodTechPhone } from '@/Utils/CommonConst';
...
//   // const [isLargeScreen, setIsLargeScreen] = useState(false); // -------> Large screen wp const
//   const dropdownRef = useRef(null);
//   const dropdownTimer = useRef(null);
//    // Use the custom hook
// const {isLargeScreen, isMobile} = useScreenSize(1024)

//   // useEffect(() => {
//   //   // Check screen size on mount and on resize
//   //   const checkScreenSize = () => {
//   //     setIsLargeScreen(window.innerWidth >= 1024); // --------> screen size
//   //   };
...
//   //   // Add event listener
//   //   window.addEventListener('resize', checkScreenSize);  // 'resize'-> type & checkScreenSize -> listener
